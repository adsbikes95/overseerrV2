        ...
        <div className="flex">
          ...
          <div className="ml-3 flex-1 md:flex md:justify-between">
            ...
            <p className="mt-3 text-sm leading-5 md:mt-0 md:ml-6">
              <a
                href="http://github.com/adsbikes95/overseerrV2"
            ...
            {status?.commitTag !== 'local' &&
              (status?.updateAvailable ? (
                <a
                  href={
                    data.version.startsWith('develop-')
                      ? `https://github.com/adsbikes95/overseerrV2/compare/${status.commitTag}...develop`
                      : 'https://github.com/adsbikes95/overseerrV2/releases'
                  }
                  target="_blank"
                ...
                <a
                  href={
                    data.version.startsWith('develop-')
                      ? 'https://github.com/adsbikes95/overseerrV2/commits/develop'
                      : 'https://github.com/adsbikes95/overseerrV2/releases'
                  }
                  target="_blank"
                  rel="noopener noreferrer"
      ...
      <div className="section">
        <List title={intl.formatMessage(messages.gettingsupport)}>
          ...
          <List.Item title={intl.formatMessage(messages.githubdiscussions)}>
            <a
              href="https://github.com/adsbikes95/overseerrV2/discussions"
              target="_blank"
              rel="noreferrer"
              className="text-indigo-500 transition duration-300 hover:underline"
            >
              https://github.com/adsbikes95/overseerrV2/discussions
            </a>
          </List.Item>
